    ...
    <Card className="w-full mx-auto relative @container/card  dark:bg-[#0a0a0a] transition-all duraiton-300 ease-in-out p-6 lg:p-10 max-h-screen lg:max-h-[680px] xl:w-[1050px] flex flex-col items-  gap-10 2xl:container  2xl:max-h-[1000px]  h-full">
      <div className="hide-scrollbar overflow-y-auto ">
        <div className="flex items-start justify-start flex-col gap-2">
          ...
          <div className="overflow-scroll z-0  hide-scrollbar mt-60  flex-1 items-start  w-full justify-start text-left pt-10 md:mt-40 pb-20">
            {messages.map((msg) => (
              <div
                key={msg.id}
                className={`mb-4 flex ${
              ...
              >
                <div
                  className={`inline-block max-w-[80%] h-full p-3 rounded-lg whitespace-pre-wrap ${
                    msg.role === "user"
                      ? "bg-black dark:bg-[#171717]  text-black dark:text-white"
      ...
      <div className=" absolute rounded-b-xl  pt-10 mask-t-from-70% bg-white dark:bg-[#0a0a0a] bottom-0 left-0 right-0 px-4 lg:px-10">
        <form
